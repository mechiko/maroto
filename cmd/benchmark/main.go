...
import (
	...
	"github.com/mechiko/maroto/v2/pkg/components/list"
	"github.com/mechiko/maroto/v2/pkg/config"
	"github.com/mechiko/maroto/v2/pkg/consts/fontstyle"
	"github.com/mechiko/maroto/v2/pkg/metrics"
	...
	"github.com/mechiko/maroto/v2/pkg/components/signature"
...
func buildFooter() []core.Row {
	return []core.Row{
		row.New(10).Add(
			...
			text.NewCol(5, "Discussions: https://github.com/mechiko/maroto/issues/257"),
			text.NewCol(5, "Branch: https://github.com/mechiko/maroto/tree/v2"),
		),
	}
}
